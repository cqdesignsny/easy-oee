...
export const dictionaries: Record<Locale, Dictionary> = {
  ...
  en: {
    ...
    "operator.locked.tag": "Plant offline",
    "operator.locked.expiredTrial": "This plant's trial has ended",
    "operator.locked.pastDue": "Plant payment past due",
    "operator.locked.canceled": "Plant subscription canceled",
    "operator.locked.body": "Ask your plant manager to open the Easy OEE billing page and renew. Once they do, refresh this screen and you can start a shift.",
    ...
    "billing.tag": "Account · Billing",
    "billing.title": "BILLING",
    "billing.subtitle": "Manage the subscription for {name}.",
    "billing.backToDashboard": "Back to dashboard",
    "billing.signInRequired": "Sign in to manage billing.",
    "billing.companyMissing": "Could not load this company.",
    "billing.stripeNotReady": "Stripe is not fully configured yet on this deployment. Subscription buttons stay disabled until the price IDs and secret key are in the environment.",
    "billing.currentPlan": "Current plan",
    "billing.trialEnds": "Trial ends",
    "billing.canceledNote": "This subscription was canceled. Start a new one anytime to restore access.",
    "billing.changeQuantity": "Change plan or line count",
    "billing.subscribeNow": "Pick a plan to subscribe",
    "billing.pickPlan": "Plan",
    "billing.redirecting": "Redirecting to Stripe...",
    "billing.startSubscription": "Subscribe with Stripe",
    "billing.updateSubscription": "Update subscription",
    "billing.existingCustomerNote": "Stripe will reuse your saved payment method.",
    "billing.error": "Could not start checkout",
  ...
  es: {
    ...
    "operator.locked.tag": "Planta fuera de servicio",
    "operator.locked.expiredTrial": "La prueba gratuita de esta planta terminó",
    "operator.locked.pastDue": "Pago de la planta vencido",
    "operator.locked.canceled": "Suscripción de la planta cancelada",
    "operator.locked.body": "Pide al gerente de la planta que abra la página de facturación de Easy OEE y renueve. Una vez hecho, actualiza esta pantalla y podrás iniciar un turno.",
    ...
    "signup.orEmail": "o regístrese con correo",
    ...
    "billing.tag": "Cuenta · Facturación",
    "billing.title": "FACTURACIÓN",
    "billing.subtitle": "Administre la suscripción de {name}.",
    "billing.backToDashboard": "Volver al panel",
    "billing.signInRequired": "Inicie sesión para administrar la facturación.",
    "billing.companyMissing": "No se pudo cargar esta empresa.",
    "billing.stripeNotReady": "Stripe aún no está configurado en este despliegue. Los botones de suscripción se mantienen deshabilitados hasta que las claves estén en el entorno.",
    "billing.currentPlan": "Plan actual",
    "billing.trialEnds": "La prueba termina",
    "billing.canceledNote": "Esta suscripción fue cancelada. Inicie una nueva en cualquier momento para restaurar el acceso.",
    "billing.changeQuantity": "Cambiar plan o número de líneas",
    "billing.subscribeNow": "Elija un plan para suscribirse",
    "billing.pickPlan": "Plan",
    "billing.redirecting": "Redirigiendo a Stripe...",
    "billing.startSubscription": "Suscribirse con Stripe",
    "billing.updateSubscription": "Actualizar suscripción",
    "billing.existingCustomerNote": "Stripe reutilizará su método de pago guardado.",
    "billing.error": "No se pudo iniciar el pago",
  ...
  fr: {
    ...
    "operator.locked.tag": "Usine hors service",
    "operator.locked.expiredTrial": "La période d'essai de cette usine est terminée",
    "operator.locked.pastDue": "Paiement de l'usine en retard",
    "operator.locked.canceled": "Abonnement de l'usine annulé",
    "operator.locked.body": "Demande au gestionnaire d'ouvrir la page de facturation Easy OEE et de renouveler. Une fois fait, rafraîchis cet écran et tu pourras démarrer un quart.",
    ...
    "signup.continueMicrosoft": "Continuer avec Microsoft",
    "signup.orEmail": "ou inscrivez-vous par courriel",
    ...
    "billing.tag": "Compte · Facturation",
    "billing.title": "FACTURATION",
    "billing.subtitle": "Gérez l'abonnement de {name}.",
    "billing.backToDashboard": "Retour au tableau de bord",
    "billing.signInRequired": "Connectez-vous pour gérer la facturation.",
    "billing.companyMissing": "Impossible de charger cette entreprise.",
    "billing.stripeNotReady": "Stripe n'est pas encore configuré sur ce déploiement. Les boutons d'abonnement restent désactivés jusqu'à ce que les clés soient dans l'environnement.",
    "billing.currentPlan": "Plan actuel",
    "billing.trialEnds": "Fin de l'essai",
    "billing.canceledNote": "Cet abonnement a été annulé. Démarrez-en un nouveau à tout moment pour restaurer l'accès.",
    "billing.changeQuantity": "Changer de plan ou de lignes",
    "billing.subscribeNow": "Choisissez un plan pour vous abonner",
    "billing.pickPlan": "Plan",
    "billing.redirecting": "Redirection vers Stripe...",
    "billing.startSubscription": "S'abonner avec Stripe",
    "billing.updateSubscription": "Mettre à jour l'abonnement",
    "billing.existingCustomerNote": "Stripe réutilisera votre moyen de paiement enregistré.",
    "billing.error": "Impossible de démarrer le paiement",
    "billing.status.trialing": "en essai",
    "billing.status.active": "active",
